...
const FAMILY_BLURBS: Record<string, string> = {
  ...
  browse: 'Current active-listing keyword and image research (Browse API)',
  media: 'eBay Picture Services image ingestion through the Media API',
  'listing-workflow': 'Deterministic local listing preflight before eBay staging',
